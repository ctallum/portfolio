...
|!["Image Vectorization"](photo%20matrix.PNG)|!["Eigenvector Array"](eigen%20matrix.PNG)|
|:-:|:-:|

The images below show the first 5 primary eigenvectors.

|!["Eigen Vector 1"](eigendog1.png)|!["Eigen Vector 2"](eigendog2.png)|!["Eigen Vector 3"](eigendog3.png)|
|:-:|:-:|:-:|

|!["Eigen Vector 4"](eigendog4.png)|!["Eigen Vector 5"](eigendog5.png)|
|:-:|:-:|
